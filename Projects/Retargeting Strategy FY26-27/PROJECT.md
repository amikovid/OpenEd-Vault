...
**Goal:** Convert parents who showed interest but never enrolled.
...
### Pillar 2: Digital Behavior Retargeting

**Goal:** Capture website visitors and ad engagers who showed interest but didn't apply.
...
### Pillar 3: Lookalike Expansion

**Goal:** Scale efficient acquisition by targeting audiences similar to enrolled students.
...
|--------|--------|----------|
| Pillar 1 conversion rate | TBD | Meta Ads Manager |
| Pillar 2 conversion rate | TBD | Meta Ads Manager |
| Pillar 3 CAC | TBD | Meta Ads Manager |
| Email nurture open rate | TBD | ESP |
| Overall pipeline recovery | TBD | CRM |
