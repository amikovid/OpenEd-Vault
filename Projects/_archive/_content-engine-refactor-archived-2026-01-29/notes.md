...
- [x]  Committed to GitHub (ab604a8)

### Next Session Approach (2026-01-23)

**Manual skill review in context of actual workflows.**

Rather than auditing skills in isolation, test them through real social media jobs:
- Run a newsletter → social spoke workflow
- Run a podcast clip extraction
- Use the skills on actual content and note friction points

This will surface:
- Which skills need more examples
- Where the chains break down
- What's missing vs what's theoretical but unused
