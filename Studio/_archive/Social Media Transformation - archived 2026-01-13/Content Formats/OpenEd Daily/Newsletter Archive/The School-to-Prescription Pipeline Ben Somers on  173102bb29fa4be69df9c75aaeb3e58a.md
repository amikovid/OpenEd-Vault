# The School-to-Prescription Pipeline: Ben Somers on How We Medicate Kids Who Don't Fit the Mold | OpenEd
...
Breakdown: - Thought: The School-to-Prescription Pipeline
- Discussion on the medication of children who do not fit traditional educational molds.
- Personal experience of Ben Somers with ADHD and the impact of medication on his childhood.

- Tool: Recess
- A platform designed to enhance education by focusing on social interactions and student choice.
- Allows kids to select classes based on their interests, ensuring engagement and motivation.
- Incorporates a friend-making component where students can connect with peers who share similar interests.

- Trend: Shift in Educational Paradigms
- Move away from traditional schooling methods towards more personalized, student-centered learning.
- Emphasis on the importance of social connections in educational retention and performance.
- Recognition of the need for flexibility in education to better suit individual learning styles and preferences.

- Fourth Segment: Future of Education
- Vision for flexible learning environments that combine physical resources with interactive, dynamic learning experiences.
- Importance of curating educational experiences that align with children's interests and values.
- Potential for technology to enhance learning while ensuring parental involvement and oversight.
...
Best Quotes: 1. "There has to be a better way. I felt wronged during my school process, but I liked learning and liked a bunch of my teachers."
2. "If you had a friend in your class, you stuck around forever. If you didn't, you churned in three to six months."
3. "The chosen class just felt electric. Every kid wanted to be there."
4. "Kid buy-in matters a lot more than we treat it or think about it."
5. "The idea that you design your kid's education, not necessarily that you facilitate every part of it."
6. "When you can make it really easy, they actually want to be involved and they want to do this stuff."
7. "Your kid could play lots of different video games and they choose to play a small number of them. Hidden in their video game choices are a bunch of preferences about what kinds of problems they like to solve."
keep: No
