...
- Notion AI for Work
- Sneak On the Lot curriculum
- 3D version of Sneak On
...
• https://sneakonthelot.com/
Breakdown: ## Thought: Fund Families Not Systems
- The book "The Parent Revolution" emphasizes the importance of parents in education.
- Parents are becoming active participants in their children's education, advocating for school choice.
- The shift towards funding families directly rather than educational systems is crucial for a responsive educational market.
- The traditional education system is being challenged as parents customize education for their children.

## Tool: Education Savings Accounts
- 17 states have implemented universal school choice programs allowing education funding to follow the student.
- These programs include options like education savings accounts, tax-credit scholarships, and vouchers.
- Families can mix and match educational services, creating a personalized learning experience.

## Trend: The Rise of Parental Activism
- The COVID-19 pandemic revealed the realities of education to parents, prompting them to demand more options.
- Parents are forming new interest groups, showing up at school board meetings, and voting for educational reforms.
- The school choice movement is seen as a significant civil rights movement in modern America.

## Additional Segment: The Unbundling of Education
- Families are moving towards a hybrid education model, mixing homeschooling, private schooling, and online learning.
- The focus is shifting from standardized education to personalized learning based on individual child needs.
- Parents are encouraged to trust their instincts and knowledge about their children's education, fostering a collaborative environment with other parents.
Created time: September 19, 2025 8:45 AM
Weekly?: No
Best of: No
Meta Description: Revolutionize education by funding families instead of systems. Parents are taking control, customizing learning options for their children, and seeing remarkable results.
Best Quotes: 1. "Parents have woken up. They're never going back to sleep. For decades, the only organized group in education represented the employees. Now there's a new sheriff in town. They're called parents." - Corey DeAngelis

2. "When you fund families directly, you create a market that actually responds to their needs." - Corey DeAngelis

3. "Think about how we actually learn. How do people learn to walk? How do kids learn to talk? The reality is most of our learning, even now, happens outside the traditional school system." - Corey DeAngelis

4. "You are your child's best teacher. Nobody knows your child better than you do." - Corey DeAngelis

5. "The parent revolution isn't about tearing down what exists—it's about building what our children actually need." - Corey DeAngelis

6. "It's not one size fits all. It's one size fits none. We should let a thousand flowers bloom instead." - Corey DeAngelis
keep: No
Orgs mentioned: OpenEd, Spotify, Alpha School, Sneak on the Lot, DreamWorks SKG, Lionsgate, Fox News
Status: Not started
Text: https://open.spotify.com/show/6Kf7SZ8XASA6tSqMEuHmVC?si=f789cdee70314085
https://a.co/d/gm4KYwT
...
## Fund Families Not Systems: How One Simple Change Could Fix American Education | OpenEd (1)
...
## The 6-Hour School Day is a Lie | OpenEd (1)
...
## What kind of homeschool parent are you? | OpenEd (1)
...
## CEO vs. Gardener: What kind of homeschool parent are you? | OpenEd (1)
...
## The Hollywood Veterans Teaching Kids to Break Into Film | OpenEd (1)
