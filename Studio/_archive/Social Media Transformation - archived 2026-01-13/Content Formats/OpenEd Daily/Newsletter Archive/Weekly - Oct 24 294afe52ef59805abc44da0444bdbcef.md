...
Tools: - Tools for Mastery-Based Learning:
- Khan Academy
- IXL Learning
- Math-U-See
- Beast Academy
...
- Quick DIY: Canva, Google Docs templates, Twinkl
- Professional print: http://homeschooldiploma.com/, DiplomaPrints
- BYU Independent Study
- Prenda
- KaiPod Learning
- Education Innovators
Tweetables]: - https://www.khanacademy.org/
- https://masterytrack.org/
- https://www.ixl.com/
- https://mathusee.com/
- https://beastacademy.com/
- http://www.aleks.com/
- https://opened.co/blog/to-diploma-or-not-to-diploma
- https://hslda.org/post/employer-asks-homeschool-grad-for-state-issued-diploma-it-doesn-t-exist
- https://opened.co/blog/why-a-public-school-principal-told-me-to-homeschool-my-kids
- https://opened.co/blog/small-schools-big-difference-a-primer-on-microschools
Breakdown: # MONDAY: Measure learning; not teaching | OpenEd (1)

- THOUGHT: The 75% Foundation
- Emphasizes the importance of complete understanding in education.
- Analogies drawn from building structures (homes, planes).
- Highlights the dangers of advancing students with only partial knowledge (75% understanding).

- TREND: Stop Measuring Teaching, Start Measuring Learning
- Scott Ellis' slogan advocating for a shift in focus from teaching metrics to actual learning outcomes.
- New data infrastructure allows schools to track student progress accurately.
- Teachers often shocked to find students lacking foundational knowledge despite passing tests.

- TOOL: Tools for Mastery-Based Learning
- Lists various home-based curricula that implement mastery tracking:
- Khan Academy: Free adaptive practice ensuring mastery before advancement.
- IXL Learning: Modules requiring consistent correct answers for mastery.
- Math-U-See: Mastery-based math curriculum for non-expert parents.
- Beast Academy: Comic-based math for younger grades focusing on understanding.
- ALEKS: AI-driven system creating personalized learning paths.

# TUESDAY: The Diploma Dilemma | OpenEd

- THOUGHT: Education as a Canvas, Not a Checklist
- Challenges the traditional path of diploma → college → job → success.
- Highlights the importance of skills, portfolios, and real-world experience over diplomas.

- TREND: When Employers Don't Understand Homeschooling
- A real-life example of a homeschool graduate facing challenges due to lack of a state-issued diploma.
- Emphasizes the importance of keeping detailed records of education.

- TOOL: How to Create a Valid Diploma
- Quick DIY options and professional printing services for creating diplomas.
- Essential information to include on a diploma.
- Notes on California homeschoolers using Private School Affidavit to issue diplomas.

- WORD OF THE DAY: Credentialism
- Definition and example illustrating its impact on job opportunities.
Created time: October 22, 2025 11:27 AM
Weekly?: No
Best of: No
...
Best Quotes: 1. "We don't build houses with 75% foundations. We don't fly planes with 75% safety checks."
2. "Stop measuring teaching. Start measuring learning." — Scott Ellis, founder of MasteryTrack.
3. "Students who passed tests are revealed to have critical missing foundations. But they can't get support because the class needs to move on."
4. "When the calendar controls learning instead of competency, boredom is a predictable result."
5. "A diploma proves you can complete requirements. A portfolio proves you can do something useful."
6. "Credentialism: the practice of overemphasizing credentials—especially academic degrees—in hiring and admissions."
7. "If this kid can take one class, just one, and feel confident, maybe they'll change their life."
8. "The question isn't whether you'll 'choose microschooling' or stay in traditional school. The question is: what's the right mix for your family, right now?"
keep: No
...
A public school administrator shares the truth about homeschooling[Ela Richmond**October 23, 2025](https://opened.co/authors/ela-richmond)
Greetings!
...
Let's dive in.
**THOUGHT:** Mind the Gap**TREND:** Be a Plane Full of Yes**TOOL:** BYU Independent Study
**Mind the Gap**
...
Small Schools, Big Difference: A Primer on Microschools[Grant Hewitt**October 22, 2025](https://opened.co/authors/grant-hewitt)
...
*Grant Hewitt is VP of Partnerships at OpenEd. Learn more about open education at [**OpenEd.co**](https://opened.co/).*
