...
- Math Academy
Tweetables]: - https://www.aei.org/op-eds/the-soft-bigotry-of-education-blather/
- https://www.aei.org/op-eds/the-soft-bigotry-of-education-blather/
- https://www.abeka.com/blog/homeschool-field-trip-ideas/
...
- https://brilliant.org/
- https://opened.co/blog/the-school-to-prescription-pipeline-ben-somers-on-how-we-medicate-kids-who-dont-fit-the-mold
- http://recess.gg/
- https://opened.co/open-education
Breakdown: - The Lawnmower Fallacy
- Thought:
- Personal anecdote about not learning small engine repair despite parental encouragement.
- Highlights the disconnect between traditional views of success (e.g., obtaining a degree) and real-life success (e.g., thriving entrepreneurs without degrees).
- Trend:
- Discussion on societal expectations of success and the pressure to conform to traditional educational paths.
- Tool:
- Emphasis on acknowledging diverse definitions of success beyond formal education.

- The Soft Bigotry of Education Blather
- Thought:
- Critique of the current state of education, particularly regarding standardized testing and student performance.
- Calls out the failure to improve educational metrics while highlighting the need for accountability.
- Trend:
- Recognition of declining student performance in reading and math.
- Tool:
- The argument for either improving the educational metrics used or eliminating them altogether in favor of more meaningful measurements.

- In the Field
- Thought:
- Suggests practical field trip ideas that enhance learning outside traditional classroom settings.
- Trend:
- Movement towards experiential learning and hands-on education.
- Tool:
- List of engaging field trip options linked to various subjects (e.g., economics, botany, civics).

- Word of the Day: Blather
- Thought:
- Definition of 'blather' and its application in education discourse.
- Trend:
- Exploration of meaningful versus meaningless communication in the context of educational discussions.
- Tool:
- Encouragement to recognize and avoid 'blather' in educational rhetoric.
Created time: October 17, 2025 9:38 AM
Weekly?: No
Best of: No
...
Best Quotes: 1. "You're not supposed to be the teacher of everything. You're the education designer."
2. "When you make it easier to be involved, parents actually want to design the experience—they just don't want to grow the wheat."
3. "If a kid had one friend in class, they stuck around forever and performed better."
4. "The era of being locked into a single, rigid system is over."
5. "You don't have to have it all figured out today. You just need to take the first step: opening your mind to the possibility that your child's education can be different."
6. "The focus shifts from fitting into predefined categories to accessing whatever resources best serve each child's needs."
7. "High standards plus life control equals status."
keep: No
...
![](https://cdn.prod.website-files.com/67e31168e49f5b7e6f76f0e5/68ed76efa22ab376da25836c_Blog%20Post%20Thumbnail%20(20).png)
...
![](https://cdn.prod.website-files.com/67e31168e49f5b7e6f76f0e5/68efc641b065e1ca78c1c8eb_Ben%20Somers%20(1).png)
...
![](https://cdn.prod.website-files.com/67e31168e49f5b7e6f76f0e5/68f1173b102ce4382b31ff2e_Blog%20Post%20Thumbnail%20(22).png)
