# Homeschooling a Child with ADHD | OpenEd

Tools: - Habitica: A tool to gamify tasks and routines.
- Visual timers: Helps with time management for ADHD students.
- Post-it systems: Better for working memory than digital planners.
- Fidgets: Tools like fidget spinners or squeeze balls to aid focus.
- Khan Academy: An online resource for math learning.
- Teaching Textbooks: Another resource for math.
- Math-U-See: A math program suitable for ADHD learners.
- Audiobooks: Paired with physical books for reading comprehension.
Tweetables]: - https://opened.co/blog/episode-019-qa-adhd-social-skills-making-hard-choices-in-alternative-education
...
- https://opened.co/
Breakdown: - Thoughts:
- Quote about judging abilities (fish and tree analogy) is often misinterpreted.
- Importance of reaching societal expectations despite differences in abilities.
- Personal experience with ADHD diagnosis later in life.
- Understanding different presentations of ADHD in children.

- Tools:
- Understanding the ADHD brain:
- ADHD is not a deficit of attention but a lack of control over it.
- Executive function is impacted, leading to developmental delays.
- The 30% Rule: ADHD individuals function about 30% behind their peers in executive function.
- The Wall of Awful: Emotional barriers to starting tasks due to past failures.

- Trends:
- Need for scaffolding in education longer than commonly expected.
- Importance of interest-based engagement rather than just importance-based motivation.
- Flexibility in homeschooling allows for changing curriculum based on effectiveness.

- Strategies:
- Build external support systems (fishbowl analogy).
- Adjust expectations based on executive function rather than chronological age.
- Simplify tasks and reduce visual clutter.
- Advocate for necessary accommodations without stigma.
- Use engaging, hands-on, and novelty-driven curriculum.
- Tools and resources: visual timers, fidget tools, body doubling, audiobooks, and gamified learning.
Created time: October 30, 2025 11:50 AM
Weekly?: No
...
Best Quotes: 1. "Everyone is a genius, but if you judge a fish on its ability to climb a tree, it will live its whole life believing it is stupid."
2. "Let us be fish because that's where we thrive. But please don't tell us we don't have to reach the top of the tree. We do."
3. "ADHD doesn't impact intelligence at all... you can get a 36 on the ACT and still do stupid things."
4. "When Alex was first diagnosed, no one explained the developmental delay in executive function for people with ADHD—about 30 percent behind their peers."
5. "Every time your ADHD student tries to do something and fails, that failure gets added to an emotional wall they have to climb over before they can even start the task again."
6. "Accommodations aren't cheating. They're leveling the playing field."
7. "Don't judge the fish on its ability to climb. Build the fish a fishbowl, and carry that fish to the top of the tree yourself."
keep: No
...
![](https://cdn.prod.website-files.com/67e31168e49f5b7e6f76f0e5/690213d2d6ed7474d8b24b5e_Gemini_Generated_Image_rb37tkrb37tkrb37.png)
...
*For more resources on homeschooling with ADHD, visit* [*OpenEd.co*](http://opened.co/) *or listen to our* [*full podcast series on ADHD and open education](https://opened.co/blog/episode-019-qa-adhd-social-skills-making-hard-choices-in-alternative-education).*